...
For this project (zenbu) I spun up a redis instance, and I really wanted a gui to play with the data inside of it. I can search for such a tool online to solve this problem. But, the tools I find will probably does more than I want, which means complexity I don't need.

...
- its an "AI app builder" with a focus on devtools
...
I'm in love with the [MacOS stage manager](https://support.apple.com/guide/mac-help/use-stage-manager-mchl534ba392/mac), it's the best GUI based window manager UX i've used. And I think it would work even better in the context of developing websites in parallel
...
<Link href="/blog/zenbu-devlog-6"> zenbu devlog #6</Link>). I thought about
everything an OS does, and tried to take the best pieces from that.
...
It's hard to imagine how much cheaper and faster models will be in the near distant future. For a huge value unlock, they don't need to get smarter, just cheaper and faster. This idea was explored more in <Link href="https://gwern.net/blog/2025/llms-can-be-faster">gwern's post</Link>.

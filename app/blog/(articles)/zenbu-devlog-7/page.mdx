...
<Image
  ...
  height={450}
/>
I started to get more inspired by the UX of OS's (mentioned in
...
The websites launched in zenbu and the website being developed in zenbu can communicate between each other trivially, since they run in the same process (the zenbu app). So, you can make very powerful tools that can inspect the runtime state of your website.
...
As time goes in, you have more tools available, and become more powerful. Its like a mini version of the recursive self improvement described in [AI 2027](https://ai-2027.com/), just the outcome is better apps made, not necessarily the end of the world.

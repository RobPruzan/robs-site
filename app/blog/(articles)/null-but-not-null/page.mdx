...
Returning something of type never is dangerous and can make your program extremely difficult to debug if you forget about it.
Use this sparingly, and as a hack to do something quickly. Just like you may temporarily use `any` on a variable to do something quickly,

...
If you want to record the users screen to understand how they use your website, you would probably first consider a browser API that just gives you that recording. One of those does exist, it's called `getDeviceMedia` and has the exact capabilities we need. But it has one big problem, you need to ask for permission before recording the users screen (reasonably?)
...
![[Pasted image 20250612031404.png]]
...
![[Pasted image 20250612034019.png]]
...
![[Pasted image 20250612040337.png]]
...
![[Pasted image 20250612040933.png]]


Now lets define which operations are dependent on each other
![[Pasted image 20250612040926.png]]
...
![[Pasted image 20250612041131.png]]
...
![[Pasted image 20250612041927.png]]

...
If you want to start hacking around with this approach, here's a fully contained file of the implementation you can run with bun- [https://github.com/RobPruzan/zenbu/blob/main/packages/zenbu-video/src/index.ts](index.ts)

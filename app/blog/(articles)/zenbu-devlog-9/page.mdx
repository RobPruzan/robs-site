...
A core feature I feel strongly about is you should be able to extend the platform using LLMs. If you want a tool that would be super useful for your niche use case, you should be able to ask the app to change itself.

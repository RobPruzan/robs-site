...
<Image
  ...
  height="600"
  width="600"
  alt="Diagram showing number and string types as infinite sets"
/>
...
<Image
  ...
  height="400"
  width="400"
  alt="Incorrect visualization of TypeScript intersection operation"
/>
...
<Image src="/typescript-article/correct-set.png" height="400" width="400" alt="Correct visualization of TypeScript intersection as set intersection" />
...
<Image
  ...
  height="600"
  width="600"
  alt="TypeScript intersection operation showing overlapping sets"
/>
#### Unions
...
<Image src="/typescript-article/correct-union.png" height="600" width="600" alt="TypeScript union operation combining two sets" />
#### Type Introspection
...
<Image src="/typescript-article/array-set.png" height="300" width="300" alt="Array type represented as a set of arrays" />

We want to apply some transformation to select the numbers out of each item and place
them in the set.

<Image src="/typescript-article/array-flat.png" height="300" width="300" alt="Flattened array type visualization" />
...
<Image src="/typescript-article/infer-diagram.png" height="800" width="800" alt="TypeScript infer keyword diagram showing type extraction" />
...
<Image src="/typescript-article/mapped-types.png" height="400" width="400" alt="TypeScript mapped types transformation diagram" />

...
Models tend to struggle pretty badly with grokking large codebases. Add on top of that a complex feature request with a bad feedback loop and it's unlikely they will get anything done.

  ...
  const projects = [
    {
      ...
      contributions: (
        <div className="space-y-3">
          <p>
            Zenbu started with me trying to build individual tools to solve
            friction points I had when making websites. For me, a tight
            development environment can be the difference between loving to
            develop vs wanting to rip my skin off. I wanted an extendable
            platform to compose all these tools together.
          </p>
          <p>
            I also started to get really into AI "app builders"/coding tools, as
